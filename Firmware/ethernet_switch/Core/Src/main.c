...
osThreadId WebUITaskHandle;
osThreadId MQTTTaskHandle;
osMessageQId mqttPublishQueueHandle;
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  /* Create the queue(s) */
  /* definition and creation of mqttPublishQueue */
  osMessageQDef(mqttPublishQueue, 16, uint32_t);
  mqttPublishQueueHandle = osMessageCreate(osMessageQ(mqttPublishQueue), NULL);
  ...
  /* definition and creation of WebUITask */
  osThreadDef(WebUITask, StartTask02, osPriorityIdle, 0, 1024);
  WebUITaskHandle = osThreadCreate(osThread(WebUITask), NULL);

  /* definition and creation of MQTTTask */
  osThreadDef(MQTTTask, StartTask03, osPriorityIdle, 0, 2048);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : SW_PME_Pin */
  GPIO_InitStruct.Pin = SW_PME_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(SW_PME_GPIO_Port, &GPIO_InitStruct);
...
/**
* @brief Function implementing the WebUITask thread.
* @param argument: Not used
* @retval None
*/
